...
<header>
    ...
    <nav>
        <ul class="cd-main-nav">
            <li><a href="#branding"class="selected">Adm <?php echo $_SESSION['name'];?></a></li>
                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" id="default">
                                        <fieldset title="Step1" class="step" id="default-step-0">
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-2 control-label">Service Conserné:</label>
                                                <div class="col-lg-10">
                                                    <select id="service" name="option">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#default').submit(function(){
            $.post('newSondage.php',$(this).serialize(), function( data, textStatus, jQxhr ){
                alert(data);
                if(data !== 'false') {
                    document.location.replace("surveyCreator.php?id="+data);
                }
                return false;
            });
            return false;
    ...
    $.post('getAllServices.php',function(data){
        data = JSON.parse(data);
        for(var i = 0 ; i < data.length; i++){
            $('#service').append("<option>"+data[i]['service']+"</option>");
        }
    });
    $(function() {
        $('#default').stepy({
